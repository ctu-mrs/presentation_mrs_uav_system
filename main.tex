...
\subsection{Mapping and planning}
  ...
  \begin{frame}
    ...
    \begin{block}{Realtime Mapping \& Planning pipeline using LiDAR, RGBD}
      \begin{center}
        \mymovie[autostart,loop]{
          \includegraphics[width=0.8\textwidth]{videos/unreal_mapping_thumbnail.jpg}
...
%%}
  ...
  \begin{frame}
    ...
    \begin{block}{Realistic simulations of UAV grasping a brick}
      \begin{center}
        \mymovie[autostart,loop]{
          \includegraphics[width=0.8\textwidth]{videos/brick_grasping_simulated_thumbnail.jpg}
  ...
  \begin{frame}
    ...
    \begin{block}{Real world UAV grasping a brick}
      \begin{center}
        \mymovie[autostart,loop]{
          \includegraphics[width=0.8\textwidth]{videos/brick_grasping_desert_thumbnail.jpg}
...
\begin{frame}
  ...
  \only<2>{
    \begin{block}{Large-scale swarms --- require high parallelization within the simulator}
      \begin{center}
        \mymovie[autostart,loop]{
          \includegraphics[width=0.75\textwidth]{./videos/swarm_14uavs_field_thumbnail.jpg}
        }{./videos/swarm_14uavs_field.mp4}
      \end{center}
    \end{block}
  }
  ...
  \only<3>{
    \begin{block}{High-fidelity visuals --- requires capable rendering engine}
      \begin{center}
        \mymovie[autostart,loop]{
          \includegraphics[width=0.60\textwidth]{./videos/ue5_example_thumbnail.jpg}
...
\begin{frame}
  ...
  \begin{columns}[c]
    ...
    \begin{center}
      \mymovie[autostart,loop]{
        \includegraphics[width=1.00\textwidth]{./videos/coppelia_thumbnail.jpg}
      }{./videos/coppelia.mp4}
    \end{center}
...
\begin{frame}
  ...
  \begin{columns}[c]
    ...
    \begin{center}
      \mymovie[autostart,loop]{
        \includegraphics[width=0.80\textwidth]{./videos/unreal_showcase_thumbnail.jpg}
