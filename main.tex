...
\begin{block}{\textbf{Soon-to-be-released update}}
  \begin{itemize}
    \item MRS UAV System to be \textbf{Independent} on the PX4 SITL
    \item Custom adapters for literally any simulator
    \item Better abstractions and modularity
  \end{itemize}
\end{block}
...
\begin{block}{CoppeliaSim}
  \begin{center}
    \mymovie[autostart,loop]{
      \includegraphics[width=0.80\textwidth]{./videos/coppelia_thumbnail.jpg}
    }{./videos/coppelia.mp4}
  \end{center}
\end{block}
...
\begin{block}{Unreal Engine 5}
\begin{center}
  \mymovie[autostart,loop]{
    \includegraphics[width=0.80\textwidth]{./videos/ue5_example_thumbnail.jpg}
...
\begin{frame}
  \frametitle{The MRS swarm simulator (To be released)}

  \begin{center}
    \mymovie[autostart,loop]{
      \includegraphics[width=0.75\textwidth]{./videos/400_swarm_thumbnail.jpg}
    }{./videos/400_swarm.mp4}\\
    Video: \url{https://youtu.be/2UJ7aYaHOX0}
  \end{center}

  \begin{center}
    Preview: \url{https://github.com/ctu-mrs/mrs_multirotor_simulator}
  \end{center}
...
\begin{frame}
  ...
  \begin{block}{Cite the MRS UAV System if you use it for your research}
