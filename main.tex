...
\begin{center}
  \mymovie[autostart,loop]{
    \includegraphics[width=0.9\textwidth]{./videos/crashes_thumbnail.jpg}
  }{./videos/crashes.mp4}\\
\end{center}
...
\only<1>{
  \begin{block}{Trajectory following}
    \begin{center}
      \mymovie[autostart,loop,start=30]{
        \includegraphics[width=0.8\textwidth]{./videos/mrs_uav_system_thumbnail.jpg}
      }{./videos/mrs_uav_system.mp4}\\
      Video: \url{https://youtu.be/WsuISKwfshA}
    \end{center}
  \end{block}
}
...
\only<2>{
  \begin{block}{Flip}
    \begin{center}
      \mymovie[autostart,loop]{
        \includegraphics[width=0.8\textwidth]{./videos/flip_thumbnail.jpg}
      }{./videos/flip.mp4}\\
    \end{center}
  \end{block}
}
...
\begin{block}{DARPA SubT Virtual - 2021}
  \begin{center}
    \mymovie[autostart,loop]{
      \includegraphics[width=0.8\textwidth]{./videos/darpa_virtual_cave_thumbnail.jpg}
